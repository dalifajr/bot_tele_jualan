            ...
            <table class="table table-hover align-middle mb-0">
                <thead>
                    <tr class="text-secondary small border-bottom">
                        <th class="px-4 py-3 border-0">Ref</th>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($complaint->status == 'new')
                                <span class="badge bg-danger-subtle text-danger rounded-pill px-3">Baru</span>
                            @elseif($complaint->status == 'review')
                                <span class="badge bg-warning-subtle text-warning rounded-pill px-3">Ditinjau</span>
