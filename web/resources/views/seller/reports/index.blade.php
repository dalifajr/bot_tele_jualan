...
@section('title', 'Laporan Operasional Seller')
@section('page_subtitle', 'Laporan')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h4 fw-bold mb-1 text-body">Laporan Operasional Seller</h1>
        <p class="text-muted mb-0">Ringkasan performa penjualan dan tren pendapatan dari stok Anda</p>
    </div>
</div>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-4 d-flex align-items-center">
                ...
                <div>
                    <h6 class="text-muted mb-1 small fw-bold">Total Produk Saya</h6>
                    <h4 class="fw-bold mb-0 text-info">{{ number_format($totalProducts) }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-transparent border-0 pt-4 px-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div>
                    <select class="form-select form-select-sm rounded-pill px-3" style="width: auto;" onchange="window.location.href = '{{ route('seller.reports.index') }}?days=' + this.value">
