...
@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-1">Pengaturan Akun Seller</h4>
    <p class="text-muted mb-0">Konfigurasikan durasi masa karantina stok akun khusus Anda secara mandiri.</p>
</div>
        ...
        <div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
            ...
            <form action="{{ route('seller.settings.update') }}" method="POST">
                ...
                <div class="bg-warning-subtle text-warning p-3 rounded-4 small mb-4">
                    ...
                    Mengubah durasi ini hanya akan memengaruhi stok akun baru yang akan Anda unggah setelah perubahan ini disimpan. Stok akun lama yang sedang dikarantina tidak akan terpengaruh durasi barunya.
                </div>
