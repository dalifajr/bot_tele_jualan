...
@section('title', __('Pengaturan Karantina'))
@section('page_subtitle', __('Pengaturan'))
            ...
            <form action="{{ route('seller.settings.update') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text mt-2 text-muted">
                        {{ __('Ini adalah durasi tunggu cooldown karantina ketika Anda mengunggah stok akun baru. Setelah durasi jam tunggu ini habis, status akun akan otomatis berubah menjadi Ready.') }}
                    </div>
                </div>
