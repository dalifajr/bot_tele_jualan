    ...
    <div class="col-md-6 col-lg-5">
        <div class="card shadow-sm border-0" style="border-radius: 16px;">
            <div class="card-body p-5 text-center">
                ...
                <h3 class="fw-bold mb-3">Akun Anda Ditangguhkan</h3>
                
                <p class="text-muted mb-4">
                    Mohon maaf, akses akun Anda ke platform ini telah ditangguhkan sementara waktu oleh administrator kami.
                </p>
                ...
                <div class="alert alert-danger-subtle text-danger border border-danger-subtle rounded-4 p-3 mb-4 text-start">
                    <div class="fw-bold mb-1"><i class="fas fa-exclamation-triangle me-2"></i>Alasan Penangguhan:</div>
                ...
                <div class="alert alert-warning mb-4 text-start small">
                    ...
                    <strong>Penting:</strong> Anda tidak dapat melakukan transaksi, menghubungi bot Telegram, maupun mengakses katalog.
                </div>

                <div class="d-grid gap-2">
                    <a href="https://t.me/{{ config('telegram.bot_username', 'Admin') }}" target="_blank" class="btn btn-primary rounded-pill py-2 fw-bold">
                        <i class="fab fa-telegram-plane me-2"></i> Hubungi Admin
                    </a>
