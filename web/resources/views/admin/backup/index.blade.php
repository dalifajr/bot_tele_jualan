        ...
        <div class="row g-3">
            <div class="col-md-6">
                <a href="{{ route('admin.backup.download', 'snapshot') }}" class="btn btn-primary rounded-pill py-3 fw-bold text-start px-4 d-flex align-items-center justify-content-between h-100">
                    <div>
                        <i class="fas fa-file-archive me-2 fs-5"></i> Download Snapshot
                        <small class="d-block fw-light text-white-50 mt-1" style="font-size: 0.75rem;">Mencakup database (SQLite/SQL) dan seluruh file QRIS/media lokal</small>
                    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center py-4 text-muted">Belum ada catatan aktivitas log audit backup.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
