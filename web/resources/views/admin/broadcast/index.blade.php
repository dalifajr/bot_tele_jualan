...
@section('title', __('Broadcast Pesan'))
@section('page_subtitle', __('Broadcast'))
...
function finishBroadcastUI(status, success, failed) {
    ...
    Swal.fire({
        ...
        html: `Laporan Pengiriman Latar Belakang:<br>{{ __('Berhasil terkirim:') }} <b>${success}</b><br>{{ __('Gagal terkirim:') }} <b>${failed}</b>`,
