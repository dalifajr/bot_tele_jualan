                ...
                <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px;">
                    <div class="card-body p-4">
                        <form action="{{ route('admin.settings.update') }}" method="POST">
                            ...
                            <p class="text-muted small mb-4">Atur koneksi SSH menuju server VPS VPN Anda. Web Jualan ini akan membuat akun VPN secara otomatis di server tersebut.</p>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="settings[vpn_server_ssh_key_raw]" class="form-control text-muted" rows="6" placeholder="-----BEGIN OPENSSH PRIVATE KEY-----&#10;...&#10;-----END OPENSSH PRIVATE KEY-----" style="font-family: monospace; font-size: 0.85rem;">{{ $settings['vpn_server_ssh_key_raw'] ?? '' }}</textarea>
                                <div class="form-text">Paste isi dari file <em>Private Key</em> Anda (.pem / id_rsa) di sini. Kunci ini digunakan untuk autentikasi SSH ke VPS secara otomatis tanpa menggunakan password. Sistem akan menyimpan dan memanfaatkannya dengan aman.</div>
                            </div>
