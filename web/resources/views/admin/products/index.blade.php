...
@section('page_subtitle', __('Produk'))
                    ...
                    <div class="tab-content" id="addProductTabContent">
                        <div class="tab-pane fade show active" id="general-add" role="tabpanel">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text small">{{ __('Format: JPG, PNG, WebP (maks. 2MB). Jika dikosongkan, detail produk akan menggunakan ilustrasi estetik.') }}</div>
                            </div>
                        </div>
