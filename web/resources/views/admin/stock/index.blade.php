...
<div class="modal fade" id="editStockModal{{ $unit->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border: none;">
            ...
            <form action="{{ route('admin.stock.update', $unit->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body p-4">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="stock_status" class="form-select">
                            ...
                            <option value="awaiting_benefits" {{ $unit->stock_status === 'awaiting_benefits' ? 'selected' : '' }}>{{ __('Awaiting Benefits') }}</option>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content text-center" style="border-radius: 16px; border: none;">
            <div class="modal-body p-4">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4">
                    <button type="button" class="btn btn-light rounded-pill px-4" data-bs-dismiss="modal">{{ __('Batal') }}</button>
                    <form action="{{ route('admin.stock.checkout') }}" method="POST" id="bulk-checkout-form">
                        @csrf
