...
class Settings(BaseSettings):
    ...
    bot_concurrent_updates: int = Field(default=8, alias="BOT_CONCURRENT_UPDATES")
    bot_http_pool_size: int = Field(default=32, alias="BOT_HTTP_POOL_SIZE")
    bot_connect_timeout_seconds: float = Field(default=5.0, alias="BOT_CONNECT_TIMEOUT_SECONDS")
    bot_read_timeout_seconds: float = Field(default=20.0, alias="BOT_READ_TIMEOUT_SECONDS")
    bot_write_timeout_seconds: float = Field(default=20.0, alias="BOT_WRITE_TIMEOUT_SECONDS")
    bot_pool_timeout_seconds: float = Field(default=5.0, alias="BOT_POOL_TIMEOUT_SECONDS")
    bot_handler_slow_ms: int = Field(default=750, alias="BOT_HANDLER_SLOW_MS")
    bot_handler_telemetry_sample_rate: float = Field(default=1.0, alias="BOT_HANDLER_TELEMETRY_SAMPLE_RATE")
    rbac_cache_ttl_seconds: int = Field(default=30, alias="RBAC_CACHE_TTL_SECONDS")
    catalog_cache_ttl_seconds: float = Field(default=3.0, alias="CATALOG_CACHE_TTL_SECONDS")
